...
plot_histogram_single <- function(data, title) {
  for (c in unique(data$country)) {
    ...
    print(plot)
    ggsave(paste("wykresy/zadanie_1_3/", "histogram_", c, ".png"), width = 24, height = 16, units = "cm")
  }
}
...
plot_histogram_multiple <- function(data, title) {
  ...
  ggsave(paste("wykresy/zadanie_1_3/", "histogram_multiple", ".png"), width = 24, height = 16, units = "cm")
}