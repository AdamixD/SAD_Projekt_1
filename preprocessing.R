...
since_2012 <- as.Date("01/07/2012", "%d/%m/%Y")
...
inflation_avg_since_2018_data <- inflation_avg_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
deposits_avg_since_2018_data <- deposits_avg_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
eurozone_inflation_since_2018_data <- eurozone_countries_inflation_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
eurozone_deposits_since_2018_data <- eurozone_countries_deposits_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
other_inflation_since_2018_data <- other_countries_inflation_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
other_deposits_since_2018_data <- other_countries_deposits_tidy %>% filter(Period >= before_pandemic & Period <= now)
...
inflation_since_2018_data <- inflation_tidy_origin %>% filter(Period >= before_pandemic & Period <= now)
...
deposits_since_2018_data <- deposits_tidy_origin %>% filter(Period >= before_pandemic & Period <= now)
